...
const UniqueData = [
  {
    id: 1,
    icon: <ClockIcon className="h-10 w-10 text-[#DBB737]" />,
  ...
  {
    id: 2,
    icon: <FireIcon className="h-10 w-10 text-[#DBB737]" />,
  ...
  {
    id: 3,
    icon: <SparklesIcon className="h-10 w-10 text-[#DBB737]" />,
  ...
  {
    id: 4,
    icon: <FaLeaf className="h-10 w-10 text-[#DBB737]" />,
  ...
  {
    id: 5,
    icon: <ShieldCheckIcon className="h-10 w-10 text-[#DBB737]" />,
  ...
  {
    id: 6,
    icon: <StarIcon className="h-10 w-10 te text-[#DBB737]" />,
